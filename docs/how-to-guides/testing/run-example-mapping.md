...
**Action**: Proceed to creating acceptance.spec and behavior.feature files
...
### Step 2: Convert Cards to Files

Follow [Create Feature Spec](./create-feature-spec.md) guide to convert:

- **Yellow Card** → `acceptance.spec` User Story section
- **Blue Cards** → `acceptance.spec` Acceptance Criteria + Acceptance Tests
- **Green Cards** → `behavior.feature` scenarios
...
- **Next**: [Create Feature Spec](./create-feature-spec.md) to convert cards to files
...
- [ATDD Concepts](../../explanation/testing/atdd-concepts.md) - Understanding Example Mapping
- [Three-Layer Approach](../../explanation/testing/three-layer-approach.md) - How it all fits together
