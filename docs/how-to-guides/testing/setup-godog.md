...
**Problem**: `godog: command not found`

**Solution**:

- Ensure `$GOPATH/bin` is in your PATH
- Restart terminal after installation
- Verify installation: `which godog` (Linux/macOS) or `where godog` (Windows)

### Undefined steps

**Problem**: `no matching step definition`

**Solution**:

- Ensure step definitions are registered in `InitializeScenario`
- Check step regex patterns match exactly
- Use `godog --verbose` to see step matching details
...
- Ensure test files are in their own package
- Don't import application code that imports test code
...
- **Next**: [Create Feature Spec](./create-feature-spec.md) to start testing

---

## Related Documentation

- [Godog Commands](../../reference/testing/godog-commands.md) - Command reference
