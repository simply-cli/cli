...
@risk-control:iot-encryption
Feature: IoT Data Encryption

  As a system administrator
  I want to implement IoT Data Encryption
...
# @implementation:required @automation:full
    ...
    @risk-control:iot-encryption-01
...
# @implementation:required @automation:full
    ...
    @risk-control:iot-encryption-02
