...
@risk-control:iot-patient-data
Feature: IoT Patient Data Protection

  As a system administrator
  I want to implement IoT Patient Data Protection
...
# @implementation:required @automation:full
    ...
    @risk-control:iot-patient-data-01
...
# @implementation:required @automation:full
    ...
    @risk-control:iot-patient-data-02
